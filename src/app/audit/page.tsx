...
export default function AuditPage() {
  ...
  const registerAuditOnChain = async () => {
    ...
    try {
      ...
      // Check if we're on EDU Chain Network (testnet)
    ...
    <div className="min-h-screen py-12">
      <div className="max-w-6xl mx-auto px-4">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-400">Get instant AI-powered security analysis for your smart contracts on EDU Chain Network</p>
          <AnimatePresence>
            {error && (
              <motion.div
                    ...
                    <div className="bg-gray-900 p-8 rounded-xl border border-blue-500/30 shadow-xl text-center">
                      ...
                      {!currentChain && (
                        <div className="mt-4 text-yellow-400 text-sm">
                          Please connect to EDU Chain Network (Mainnet or Testnet)
                        </div>
                      )}
                    </div>
                  </div>
