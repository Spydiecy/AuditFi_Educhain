...
// Simplified chain config to only include EDU Chain Network
const CHAIN_CONFIG = {
  educhainTestnet: {
...
const features = [
  ...
  },
  {
    ...
    description: 'Audit smart contracts on EDU Chain network'
  },
  {
    icon: Code,
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-gray-400 text-lg mb-8 max-w-xl">
                Secure your smart contracts with AI-powered analysis, documentation, and on-chain verification. Get instant security audits powered by Finetuned AI, now optimized for EDU Chain Network.
              </p>
      ...
      <section className="py-20 bg-gradient-to-b from-gray-900/95 to-gray-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <h2 className="text-4xl font-bold font-mono mb-4">
              <span className="text-blue-400">EDU Chain</span> Network Integration
            </h2>
            <p className="text-gray-400 text-lg max-w-2xl mx-auto">
              Optimized for the EDU Chain Network ecosystem with native support for EDU tokens
            </p>
          </motion.div>
          ...
          <div className="max-w-3xl mx-auto">
            ...
            >
              ...
              <div>
                <h3 className="font-semibold text-xl mb-1">EDU Chain Testnet</h3>
                <p className="text-gray-400">Native Token: <span className="text-blue-400 font-semibold">EDU</span></p>
                <div className="flex flex-wrap gap-2 mt-2">
                  <a href="https://opencampus-codex.blockscout.com" target="_blank" rel="noopener noreferrer" className="text-sm text-blue-400 hover:text-blue-300 flex items-center space-x-1">
                    <span>Block Explorer</span>
                    <ArrowRight size={14} weight="bold" />
                  </a>
                  <a href="https://open-campus-codex-sepolia.drpc.org" target="_blank" rel="noopener noreferrer" className="text-sm text-blue-400 hover:text-blue-300 flex items-center space-x-1">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
            ...
            <div>
              ...
              <div className="flex items-center space-x-6">
                <a href="https://github.com/Spydiecy/AuditFi_Educhain" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-blue-400 transition-colors">
                  <GithubLogo size={24} weight="fill" />
                </a>
                <a href="https://twitter.com/AuditFi_ai" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-blue-400 transition-colors">
                  <TwitterLogo size={24} weight="fill" />
                </a>
                <a href="https://open-campus-codex-sepolia.drpc.org" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-blue-400 transition-colors">
                  <DiscordLogo size={24} weight="fill" />
                </a>
                <a href="https://opencampus-codex.blockscout.com" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-blue-400 transition-colors">
